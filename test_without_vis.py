        ...
        for batch_id, batch_pcd in enumerate(tqdm(test_dataloader)):
            ...
            if cfg.save_results and len(not_repeat) < 15:
                if batch_pcd[1][0] not in not_repeat:
                    ...
                    #Store batch_cpd, batch_pred, task, batch_id in a data dict and save it to a file
                    data_points.append({'batch_pcd': batch_pcd, 'batch_pred': batch_pred, 'task': cfg.task, 'batch_id': batch_id})
