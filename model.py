...
class SerializedAttention(PointModule):
    ...
    def forward(self, point):
        ...
        if not self.enable_flash:
            ...
            feat = flash_attn.flash_attn_interface.flash_attn_unpadded_qkvpacked_func(
...
class PointTransformerV3_512(PointModule):
    def __init__(
        self,
        in_channels=3,
        order=("z", "z-trans", "hilbert", "hilbert-trans"),
...
class PointTransformerV3_256(PointModule):
    def __init__(
        self,
        in_channels=3,
        order=("z", "z-trans", "hilbert", "hilbert-trans"),
...
class PointTransformerV3_128(PointModule):
    def __init__(
        self,
        in_channels=3,
        order=("z", "z-trans", "hilbert", "hilbert-trans"),
